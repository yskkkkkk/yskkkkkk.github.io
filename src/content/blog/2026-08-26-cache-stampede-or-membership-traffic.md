...
즉, 비회원의 300여 건 캐시 미스가 문제가 아니라, 2만 3천 건에 달하는 대규모 회원 요청이 캐시를 1밀리초도 거치지 않고 100% DB로 직행하고 있었던 겁니다. 5분 사이에 수천 건의 회원 조회가 DB로 한꺼번에 쏟아지니 커넥션 풀이 버텨낼 리가 없었죠.
...
특수한 유입 상황 하나가 아키텍처의 숨은 빈틈을 짚어주고, 명확한 개선 방향과 값진 트러블슈팅 경험까지 안겨주어서 엔지니어로서 참 행복한 이슈였네요...
